...
(function (window) {
  ...
  var SAMPLE_RAW_EMAILS = {
    ...
    sample_stubbed:
      "Received: from test.local (192.0.2.1) by mx.local with SMTP id t123\r\n" +
      "        for <all@company.com>; Thu, 27 Aug 2026 13:00:00 +0000 (UTC)\r\n" +
      "From: SysAdmin <admin@systems.net>\r\n" +
      "To: all@company.com\r\n" +
      "Subject: Pending system maintenance announcement\r\n" +
      "Date: Thu, 27 Aug 2026 13:00:00 +0000\r\n\r\n" +
      "Scheduled maintenance window will begin tonight at 23:00 UTC."
  };
      ...
      .catch(function (err) {
        ...
        if (err && err.code) {
          ...
          reject({
            ...
            userMessage: "Unable to connect to analysis service on " + API_BASE + ". Ensure backend is running."
          });
        }
      });
    });
